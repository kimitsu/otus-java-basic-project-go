package ru.otus.java.basic.project.go.client.windows;

import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;
import ru.otus.java.basic.project.go.api.context.GameContext;
import ru.otus.java.basic.project.go.api.enums.GameState;
import ru.otus.java.basic.project.go.api.enums.MoveType;
import ru.otus.java.basic.project.go.api.messages.server.ErrorServerMessage;
import ru.otus.java.basic.project.go.api.messages.server.GameStateServerMessage;
import ru.otus.java.basic.project.go.client.Client;
import ru.otus.java.basic.project.go.client.SwingUtils;
import ru.otus.java.basic.project.go.client.components.Board;
import ru.otus.java.basic.project.go.client.components.StoneColor;
