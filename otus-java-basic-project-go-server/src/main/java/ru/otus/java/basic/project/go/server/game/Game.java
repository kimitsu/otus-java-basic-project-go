...
import ru.otus.java.basic.project.go.api.messages.client.GameMoveClientMessage;
import ru.otus.java.basic.project.go.api.messages.server.GameInfoServerMessage;
...
import ru.otus.java.basic.project.go.server.exceptions.IllegalMoveException;
import ru.otus.java.basic.project.go.server.ClientConnection;
